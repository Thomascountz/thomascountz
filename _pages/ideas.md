...
## Software Projects
- Pros & Consequences
  - Word cloud: Prosequence, Intention, tAsk-whY 
  - A todo list app which captures the _what_ and the _or else what_ for each todo
  - Inspired by <https://www.softwaredesign.ing/blog/todo-list-that-actually-works>
  - Each task, you have to pick either done or accept consequence 
...
- "Flat-Pak" Drawbot
  - Laser cut drawbot with simple parts-list
  - Inspiration: <https://makezine.com/projects/learn-inverse-kinematics-with-a-robot-arm-drawbot/>
- Weighted Lamp
  - A lamp whose brightness is controlled by how much weight it placed on it
  - Inspiration: <https://www.yankodesign.com/2025/04/18/glass-lamp-with-fabric-cover-transforms-lighting-into-a-mindful-ritual/>
- DSP to double GPIO
  - Use high- and low-pass filters to double the number of GPIO pins
  - Inspiration: <https://hackaday.com/2025/04/05/8-pins-for-linux/>
- LED Light Comms
  - Receive data via LEDs
  - Inspiration: <https://mitxela.com/projects/lightcomm>
